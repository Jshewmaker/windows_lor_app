    ...
    return _then(_value.copyWith(
      ...
      descriptionRaw: descriptionRaw == freezed
          ...
          : descriptionRaw // ignore: cast_nullable_to_non_nullable
              as String,
      levelupDescriptionRaw: levelupDescriptionRaw == freezed
          ? _value.levelupDescriptionRaw
          : levelupDescriptionRaw // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_CardModel with DiagnosticableTreeMixin implements _CardModel {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('descriptionRaw', descriptionRaw))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.levelupDescriptionRaw, levelupDescriptionRaw) &&
            const DeepCollectionEquality()
...
abstract class _CardModel implements CardModel {
  const factory _CardModel(
      ...
      required final String descriptionRaw,
  ...
  @override
  String get levelupDescriptionRaw;
  @override

...
class _$_Game with DiagnosticableTreeMixin implements _Game {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Game(playerName: $playerName, opponentName: $opponentName, gameState: $gameState, screen: $screen, rectangles: $rectangles)';
  }
...
abstract class _Game implements Game {
  const factory _Game(
      ...
      required final Map<String, int>? screen,
      required final List<Map<String, dynamic>>? rectangles}) = _$_Game;
